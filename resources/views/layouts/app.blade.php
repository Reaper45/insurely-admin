            ...
            <nav class="bg-white border border-gray-300 border-solid border-1 border-t-0 border-l-0 border-r-0">
                    ...
                    <div class="flex items-center justify-between h-16">
                        <div class="flex items-center">
                            ...
                            <div class="hidden md:block">
                                ...
                                <a href="#" class="px-3 py-2 rounded-md text-sm font-medium text-blue focus:outline-none focus:text-blue-800 ">Dashboard</a>
                                </div>
                            </div>
                        </div>
                        <div class="hidden md:block">
                ...
                <div class="hidden md:hidden">
                    <div class="px-2 pt-2 pb-3 sm:px-3">
                        <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-white bg-blue-900 focus:outline-none focus:text-white focus:bg-blue-700">Dashboard</a>
                    </div>
