      ...
      <div class="flex">
        <div class="w-1/5  h-12">
          <div class=" bg-white border-r" aria-orientation="vertical" aria-labelledby="options-menu">
            ...
            <div class="py-1">
              <!-- classes list -->
              <a href="{{route('settings.benefits')}}" class="block px-4 py-3 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">Benefits</a>   
            </div>
          </div>
        </div>
